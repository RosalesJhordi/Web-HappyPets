...
Route::middleware([CheckPermissions::class. ':Administrador,Almacenero'])->group(function () {
...
Route::middleware([CheckPermissions::class. ':Administrador,Veterinario'])->group(function () {
...
Route::middleware([CheckPermissions::class. ':Administrador,Cajero/Vendedor'])->group(function () {
