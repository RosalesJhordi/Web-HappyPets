<div class="max-w-2xl px-4 py-5 mx-auto sm:px-6 sm:py-10 lg:max-w-7xl lg:px-8">
    ...
    <div class="grid grid-cols-2 gap-2 mt-8 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">
        @foreach ($datos as $dato)
            <div
                class="w-full p-4 transition-transform transform bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-lg hover:-translate-y-1">
                <div class="relative overflow-hidden rounded-md cursor-pointer"
                    ...
                    <img src="{{ 'https://api.happypetshco.com/ServidorServicios/' . $dato['imagen'] }}"
                        alt="{{ $dato['tipo'] }}"
                        class="object-cover w-full transition-opacity duration-300 ease-in-out h-60 hover:opacity-90">
                </div>
                <div class="p-4">
