            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                        <i class="w-6 h-6 text-lg text-gray-500 fa-solid fa-dog"></i>
                ...
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base transition duration-75 rounded-lg group {{ $activeButton === 'clientes' ? 'bg-blue-600 text-white hover:bg-blue-500' : 'text-gray-900 hover:bg-gray-200' }}"
                        aria-controls="dropdown-example2" data-collapse-toggle="dropdown-example2">
                        <svg class="flex-shrink-0 w-5 h-5 {{ $activeButton === 'clientes' ? 'text-white' : 'text-gray-500' }}  transition duration-75 " aria-hidden="true"
