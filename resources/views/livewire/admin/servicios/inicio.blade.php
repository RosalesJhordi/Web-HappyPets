<div class="fw-full">
    ...
    <div class="flex w-full gap-5">
        ...
        <button onclick="my_modal_3.showModal()"
            ...
            <span>
                <h1 class="text-lg font-bold text-gray-400">Añadir Servicio</h1>
            </span>
        </button>
    </div>
    ...
    <dialog id="my_modal_3" class="modal" wire:ignore.self>
        <div class="w-11/12 max-w-6xl modal-box">
            ...
            <form class="flex flex-col items-center justify-center gap-2 px-5 py-5" wire:submit="addServicio"
                novalidate>
    ...
    @if ($ver)
        <button wire:click="ocultar" type="button" class="mt-2 text-xl btn btn-primary">
            x
        </button>
        ...
        <div class="flex items-center justify-center">
            ...
            <div class="flex items-center justify-between h-auto border rounded-sm shadow-xl card card-side"
                ...
                <figure class="w-1/2 h-full">
                    <img src="{{ 'https://api.happypetshco.com/ServidorServicios/' . $data['imagen'] }}"
                        alt="Imagen servicio {{ $data['tipo'] }}" class="object-cover w-full h-full" />
                </figure>
                ...
                <div class="w-1/2 h-full px-5 py-5 bg-slate-50">
                    ...
                    <form class="flex flex-col w-full gap-2 py-4" wire:submit.prevent="editardatos" novalidate>
                        ...
                        <label class="flex items-center gap-2 input input-bordered">
                            ...
                            <span class="w-1/2 text-white badge bg-rosa">Tipo</span>
                        </label>
                ...
                <tbody wire:loading.remove>
                    ...
                    @forelse ($datos as $dato)
                        <tr wire:key="{{ $dato['id'] }}">
                            ...
                            <td class="w-10 border">
                                <span
                                    class="inline-flex items-center px-2 py-1 text-sm font-medium rounded-md text-fuchsia-700 bg-fuchsia-50 ring-1 ring-inset ring-fuchsia-700/10">
                                    {{ $dato['tipo'] }}
                                </span>
                            ...
                            <th class="w-40 border">
                                <div class="tooltip" data-tip="Ver">
                                    <button type="button" wire:click="verservicio({{ $dato['id'] }})"
