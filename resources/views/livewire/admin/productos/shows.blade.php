        ...
        <div class="w-1/2 h-full px-5 py-5">
            ...
            <form action="" class="flex flex-col w-full gap-2 py-4" wire:submit.prevent="editardatos" novalidate>
                ...
                <div class="flex items-center justify-end w-full gap-2 py-5">
                    <button type="submit"
                        class="flex justify-center font-semibold text-blue-600 bg-blue-200 border border-blue-600 btn hover:bg-blue-600 hover:text-white items-center">
                        Guardar cambios
                    ...
                    <button type="button" wire:click="delete"
                        class="flex justify-center font-semibold text-red-600 bg-red-200 border border-red-600 btn hover:bg-red-600 hover:text-white items-center">
                        Eliminar
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
