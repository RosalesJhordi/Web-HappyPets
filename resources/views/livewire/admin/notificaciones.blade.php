                ...
                <div class="flex items-center mr-3">
                    <div class="text-2xl indicator">
                        <span class="text-xs indicator-item badge badge-primary">
                            @if ($datosCarrito)
                                {{ count($NotiPedido + $NotiCita + $NotiNovedad) }}
                            @else
                                0
                            @endif
                        </span>
                    ...
                    <div class="tabs">
                        <div class="block" wire:ignore.self>
                            <ul
                                ...
                                {{-- Mostrar Pedidos si el usuario tiene permiso --}}
                                @if (in_array('Administrador', $this->permisos) || in_array('Cajero/Vendedor', $this->permisos))
                                ...
                                {{-- Mostrar Citas si el usuario tiene permiso --}}
                                @if (in_array('Administrador', $this->permisos) || in_array('Veterinario', $this->permisos))
                                    <li class="w-full text-center">
                                        <a href="javascript:void(0)"
                                ...
                                {{-- Mostrar Novedades si el usuario tiene permiso --}}
                                                ...
                                                <div class="p-4 md:flex md:items-center">
                                                    <div class="flex-1 space-y-1">
                                                        ...
                                                        <p class="text-sm font-semibold text-gray-900">
                                                            ...
                                                            <span>{{ \Carbon\Carbon::parse($noti['created_at'])->diffForHumans() }}</span>
                                                    </div>
                                                ...
                                                <div class="p-4 md:flex md:items-center">
                                                    <div class="flex-1 space-y-1">
                                                        ...
                                                        <p class="text-sm font-semibold text-gray-900">
                                                            ...
                                                            <span>{{ \Carbon\Carbon::parse($notii['created_at'])->diffForHumans() }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                                        ...
                                        @forelse ($NotiNovedad as $noti)
                                            <div class="bg-white border border-gray-200 rounded-lg shadow-md">
                                                <div class="p-4 md:flex md:items-center">
                                                    ...
                                                    <div class="mt-4 md:mt-0 md:ml-4">
                                                        <button
                                                            wire:click='MarcarLeidoNovedades("{{ $noti['id'] }}")'
                                                            class="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-md shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-75">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                viewBox="0 0 24 24" stroke-width="1.5"
                                                                stroke="currentColor" class="size-2">
