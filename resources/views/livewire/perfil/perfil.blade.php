    ...
    <div class="max-w-xl px-4 py-5 mx-auto sm:px-6 sm:py-10 lg:max-w-5xl lg:px-8">
        ...
        @if ($historial)
            ...
            <h2 class="w-full py-3 text-2xl text-center border-b">
                Historial de la mascota {{ $mascotaHistorial['nombre'] }}
            </h2>
            <div class="py-5">
                ...
                <div class="w-full mt-3 border-t">
                    <p class="text-sm text-gray-600">Raza: {{ $mascotaHistorial['raza'] }}</p>
                    <p class="text-sm text-gray-600">Edad: {{ $mascotaHistorial['edad'] }}</p>
                    <p class="text-sm text-gray-600">Sexo: {{ $mascotaHistorial['sexo'] }}</p>
