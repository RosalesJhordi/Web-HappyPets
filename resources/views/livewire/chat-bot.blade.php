                            ...
                            <div class="flex flex-col justify-end w-full text-right">
                                ...
                                <div class="flex flex-col justify-end w-full">
                                    <div class="flex items-center justify-end w-full">
                                        <div
                                            class="px-3.5 py-2 bg-green-500 text-white max-w-60 w-auto h-auto flex  rounded justify-end items-end gap-3">
                        ...
                        <div class="flex gap-2.5">
                            ...
                            <div class="grid">
                                ...
                                <div class="grid w-full">
                                    <div
                                        class="px-3.5 py-2 bg-blue-500 text-white w-60 h-auto  rounded justify-start items-center gap-3 inline-flex">
                                        <h5 class="w-full h-auto text-sm font-normal leading-snug text-white">
                                            {{ $message['text'] }}
                                        </h5>
                                    </div>
                                    <div class="justify-end items-center w-60 inline-flex mb-2.5">
            ...
            <div
                ...
                <div class="flex items-center w-full gap-2">
                    ...
                    <input
                        ...
                        placeholder="Tu mensaje..." wire:model.defer="text">

                </div>
                <div class="flex items-center gap-2">
                    <button wire:click="sendMessage" wire:keydown.enter='sendMessage'
                        class="flex items-center px-3 py-2 bg-indigo-600 rounded-full shadow ">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                if (!SpeechRecognition) {
                    ...
                    alert(
                        "Tu navegador no soporta reconocimiento de voz. Por favor, usa un navegador moderno como Google Chrome."
                    );
                    return;
                }
                ...
                if (!startBtn || !stopBtn || !transcriptEl) {
                ...
                const toggleButtons = () => {
                    startBtn.hidden = isRecognizing;
                    stopBtn.hidden = !isRecognizing;
                };
                ...
                recognition.onerror = (event) => {
                    ...
                    alert("Ocurrió un error durante la transcripción: " + event.error);
                };
...
<script>
    ...
    window.addEventListener('redirectService', event => {
        setTimeout(() => {
            @this.redirectToServices('goo');
        }, 3000);
    });
</script>
