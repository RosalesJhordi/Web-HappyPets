    ...
    <div class="drawer drawer-end">
        ...
        <div class="drawer-content">
            ...
            <label for="my-drawer-4" class="drawer-button">
                <div id="openDrawer" class="mr-4 text-gray-400 indicator hover:text-gray-500">
            ...
            <ul class="w-1/4 min-h-full p-4 bg-white menu text-base-content" style="z-index: 9999;">
                ...
                @if (Session::get('authToken'))
                        ...
                        @foreach ($datos as $dato)
                            <div class="flex items-start py-6">
                                <div class="flex-shrink-0 w-24 h-24 overflow-hidden border border-gray-200 rounded-md">
                                    <img src="{{ 'https://api-happypetshco-com.preview-domain.com/ServidorProductos/' . $dato['producto']['imagen'] }}" alt="imagen de producto"
                                ...
                                <div class="flex flex-col flex-1 ml-4">
                                    <div>
                                        ...
                                        <p class="mt-1 text-sm text-gray-500">{{ $dato['producto']['categoria'] }}</p>
                                    </div>
                    ...
                    <div class="sticky bottom-0 z-50 px-4 py-6 bg-white border-t border-gray-200 sm:px-6">
                        ...
                        <div class="mt-6">
                            <a href="#"
                                class="flex items-center justify-center px-6 py-3 text-base font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-700">Confirmar compra</a>
                        </div>
